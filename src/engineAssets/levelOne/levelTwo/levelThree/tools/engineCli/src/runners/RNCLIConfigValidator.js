  ...
  _generateConfigIfDoesNotExist() {
    if (!fs.existsSync(newPath)) {
      fs.writeFileSync(
        newPath,
        `\
// This file was generated by @{MOD_GITHUB_USERNAME}/{MOD_APP_NAME} on ${new Date().toDateString()}
// You can extend it if you want, but leave the defaults to be required from the engine config

module.exports = {
  ...require('./node_modules/@{MOD_GITHUB_USERNAME}/{MOD_APP_NAME}/tools/engineCli/etc/metro.config')
};
`,
      )
    }
